...
module.exports = (config, options) => {
  ...
  exports.buildTranslationsConfig = function () {
    config.translations = {
      ...
      project: (config.translations && config.translations.project) ? config.translations.project : (config.plugin && config.plugin.id) ? config.plugin.id : path.basename(process.cwd())
    }
  }
