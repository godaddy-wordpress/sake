...
module.exports = (config, options) => {
  ...
  exports.buildPluginConfig = function () {
    ...
    let pluginID = (config.plugin && config.plugin.id) ? config.plugin.id : path.basename(process.cwd())
    ...
    config.plugin = {
      ...
      translations: {
        project: (config.plugin && config.plugin.translations && config.plugin.translations.project) ? config.plugin.translations.project : pluginID,
        version: changelog.plugin_version,
        glotpress: (config.plugin && config.plugin.translations && config.plugin.translations.glotpress) ? config.plugin.translations.glotpress : 'https://translations.skyverge.com/glotpress/'
      }
    }
